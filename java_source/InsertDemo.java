...
public class InsertDemo {
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		DBObject document = new BasicDBObject("java","powered");

		codedCol.insert(document);	// check for doc with {"java":"powered"}

		for(int i=0; i < 30; i++) {
			document = new BasicDBObject("counter",i);
			document.put("looped", true);
